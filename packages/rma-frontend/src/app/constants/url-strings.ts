...
// STOCK LEDGER
export const LIST_LEDGER_REPORT_ENDPOINT = '/api/stock_ledger/v1/ledger_report';
export const LIST_STOCK_LEDGER_ENDPOINT =
  '/api/stock_ledger/v1/list_stock_ledger';
export const VOUCHER_TYPE_LIST = '/api/stock_ledger/v1/get_voucher_type';
